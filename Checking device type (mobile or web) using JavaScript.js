...
if(oW <= 480) // checking if the original width (so far calculated) is less than 481 pixels.
    top.window.location.href="mobile.php"; //Opening mibile page for device width of less than the mentioned condition.
    ...
    else window.location="web-version.php";//OPening Web-View for devices with width greater than mentioned condition.
    }
</script>
